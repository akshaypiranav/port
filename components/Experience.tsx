...
<div className="container mt-5" id="experience">
  ...
  <div className="row">
    ...
    <Link href="https://quantanics.in/" target="_blank">
      ...
      <div className="card bgg" style={{ width: "18rem" }} data-aos="zoom-in-right">
    ...
    <Link href="https://phoenixsoftech.in/" target="_blank">
      ...
      <div className="card bgg" style={{ width: "18rem" }} data-aos="zoom-out">
    ...
    <Link href="https://quarksek.com/" target="_blank">
      ...
      <div className="card bgg" style={{ width: "18rem" }} data-aos="zoom-in-left">
